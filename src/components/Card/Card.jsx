...
const Card = () => {
    ...
    return (
        <section className="container mx-auto   md:px-8 px-4">
           ...
           <Slider {...settings}>
        <section className="p-3 py-4 bg-[#F5F5F5] group text-center transform duration-500 hover:-translate-y-2 cursor-pointer hover:border-[#A17D60] border rounded-sm">
