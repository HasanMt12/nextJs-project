...
const Card = () => {
  ...
  <span class="absolute -bottom-1 left-0 w-full h-1 bg-gradient-to-r from-red-500 via-orange-400 to-yellow-600 rounded-full"></span>
    ...
    <section
        ...
        <section class="p-3 py-4 bg-purple-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
            <img src="https://www.dropbox.com/s/mlor33hzk73rh0c/x14423.png?dl=1" className=" w-[200px] h-[220px] mx-auto"  alt=""  />
            ...
            <h1 class="text-lg my-5">Soft Plushy Cushion Chair</h1>
        ...
        <section class="p-3 py-4 bg-green-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
            <img src="https://www.dropbox.com/s/8ymeus1n9k9bhpd/y16625.png?dl=1" className=" w-[200px] h-[220px] mx-auto"  alt=""  />
            <div class="space-x-1 flex justify-center mt-10">
                <svg class="w-4 h-4 mx-px fill-current text-orange-600" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 14 14">
                    <path
            ...
            <h1 class="text-lg my-5">Comfortable Wooden Chair</h1>
        ...
        <section class="p-3 py-4 bg-red-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
            <img src="https://www.dropbox.com/s/ykdro56f2qltxys/hh2774663-87776.png?dl=1" className=" w-[200px] h-[220px] mx-auto"  alt=""  />
            <div class="space-x-1 flex justify-center mt-10">
                <svg class="w-4 h-4 mx-px fill-current text-orange-600" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 14 14">
                    <path
            ...
            <h1 class="text-lg my-5">Multipurpose Wooden Trolly</h1>
        ...
        <section class="p-3 py-4 bg-blue-50 text-center transform duration-500 hover:-translate-y-2 cursor-pointer">
            <img src="https://www.dropbox.com/s/1fav310i2eqkdz8/tool2.png?dl=1" className=" w-[200px] h-[220px] mx-auto"  alt=""  />
            <div class="space-x-1 flex justify-center mt-10">
                <svg class="w-4 h-4 mx-px fill-current text-orange-600" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 14 14">
                    <path
            ...
            <h1 class="text-lg my-5">Multipurpose Wooden Tool</h1>
